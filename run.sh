...
clear
echo "Katacoda Centos Windows 11 by fb.com/thuong.hai.581 Edit region Asia/Pacific by 94maldini"
...
echo Script by fb.com/thuong.hai.581 Edit region Asia/Pacific by 94maldini
